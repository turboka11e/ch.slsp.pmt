 ...
 */
final class Version20211129131307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_DB055AF39D86650F ON submission');
        $this->addSql('ALTER TABLE submission CHANGE user_id_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE submission CHANGE user_id user_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE submission ADD CONSTRAINT FK_DB055AF39D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_DB055AF39D86650F ON submission (user_id_id)');
    }
}
